    ...
    <div className='container-fluid'>
      <div className='row'>
        ...
        <div className='col-md-4 picture'>
          <img height='300px' width='300px' src={userProfile.user.pic} alt='imageHere'></img>
        </div>
        ...
        <div className='col-md-8 d-block my-5'>
          ...
          <div className='d-flex'>
            ...
            <p style={{marginLeft:'50px',marginTop:'10px'}}><strong>{userProfile.user.following.length}</strong> Followings</p>
          </div>
            
          <div>
            <p style={{marginLeft:'20px'}}>Full Stack Developer</p>
          </div>
        </div>
      ...
      <div className='row'>
        
        {
          userProfile.posts.map(item=>{
            ...
            <p style={{textAlign:'center'}} className='paragraph'>{item.body}</p>
        </div> 
            )
          })
        }
